...
TIP: Los nombres de las copias de seguridad del repositorio tienen el prefijo “nsm” o “SC_Quartz”. Dado que la función de restauración del repositorio busca esos prefijos, no debe cambiarlos.
