...
* Si desea backups consistentes de la máquina virtual, debe tener instalado y en ejecución VMware Tools. Se necesitan VMware Tools para activar las máquinas virtuales.
...
.Pasos
. En el panel de navegación izquierdo del cliente web de VMware vSphere, haga clic en *Policies*.
...
+
image:scpivs44_image15.png["Error: Falta la imagen gráfica"]
...
NOTE: Esta opción es compatible para almacenes de datos en volúmenes de FlexGroup que comiencen en el plugin de SnapCenter para VMware vSphere 4.5. Esta opción no es compatible para almacenes de datos en FlexGroup Volumes en el plugin de SnapCenter para VMware vSphere 4.4 y versiones anteriores.
...
IMPORTANT: Debe tener en ejecución VMware Tools en la máquina virtual para realizar backups consistentes de la máquina virtual. Si VMware Tools no está en ejecución, se realiza un backup coherente con los fallos.
